      ...
      <footer className="py-12 border-t border-line">
        <div className="container mx-auto px-8 lg:px-12 max-w-7xl">
          ...
          <div className="mb-8">
            ...
            <div className="font-satoshi text-sm text-text-secondary leading-relaxed py-4 pl-4 sm:pl-8 md:pl-16 lg:pl-24 xl:pl-32">
          ...
          <div className="mb-8">
            ...
            <p className="font-satoshi text-sm text-text-secondary leading-relaxed px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32">
          ...
          <div className="flex  flex-col items-center my-12 gap-5 ">
            <div className="font-satoshi text-sm text-text-primary mb-2">
            ...
            {socialLinks.map((link) => (
              <a
                ...
                target="_blank"
                href={link.href}
                className="font-satoshi text-sm text-text-secondary hover:text-primary transition-colors duration-300 flex items-center px-2"
              >
                {link.logo}
          ...
          <div className="w-full overflow-hidden">
            <div className="overflow-x-auto scrollbar-hide text-center">
              <div className="font-satoshi text-xs text-text-muted whitespace-nowrap inline-block min-w-max ">
